...
def main() -> None:
    required = {
        ...
        "phase1_decision": QA_DIR / "phase1_import_decision.json",
        "full_review_decision": QA_DIR / "full_ranked_review_decision.json",
        ...
        "top20_notes_template": QA_DIR / "top_20_operator_notes_template.csv",
        "review_followup_queue": QA_DIR / "review_followup_queue.csv",
        "packet_index": QA_DIR / "clickup_import_packet_index.txt",
        "operator_pack_health": QA_DIR / "operator_pack_health.json",
        "phase1_row_sample": QA_DIR / "phase1_import_row_sample.json",
        "full_row_sample": QA_DIR / "full_ranked_row_sample.json",
        "rank_bucket_examples": QA_DIR / "rank_bucket_top_examples.txt",
        "review_bucket_examples": QA_DIR / "review_bucket_top_examples.txt",
